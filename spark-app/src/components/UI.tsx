...
const ICONS: Record<IconName, React.ReactElement> = {
  ...
  thumbsUp: (
    <>
      <path d="M7 10v11" />
      <path d="M7 10l4-7c1.5 0 2.5 1 2.5 2.5V10h5a2 2 0 0 1 2 2.3l-1.4 7A2 2 0 0 1 17 21H7" />
    </>
  ),
  thumbsDown: (
    <>
      <path d="M17 14V3" />
      <path d="M17 14l-4 7c-1.5 0-2.5-1-2.5-2.5V14h-5a2 2 0 0 1-2-2.3L5 4.7A2 2 0 0 1 7 3h10" />
    </>
  ),
  copy: (
    <>
...
export function Avatar({
  ...
  const styleByTone =
    tone === "amber"
      ...
      : undefined;
  return (
    <span className={`avatar ${size}`} style={styleByTone as React.CSSProperties | undefined}>
      {initials}
    </span>
  );
}
